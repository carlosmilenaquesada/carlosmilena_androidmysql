package com.example.pm_mysql.utilidades;
...
public class ImagenesBlobBitmap{
	...
	// imageView.setImageBitmap(decodeSampledBitmapFromResource(getResources(), R.id.myimage, 100,
	// 100));
	// mas información aquí: -> https://developer.android.com/topic/performance/graphics/load-bitmap#java

	public static Bitmap decodeSampledBitmapFrombyteArray(byte[] fotob, int reqWidth,
														  int reqHeight){
		// First decode with inJustDecodeBounds=true to check dimensions
		final BitmapFactory.Options options = new BitmapFactory.Options();
		options.inJustDecodeBounds = true;
